...
<body>
    ...
    <div id="content-wrapper">
        <section>
        <h2 style="text-align: center;">Daftar Penambahan Informasi</h2>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <table border="1" cellpadding="10" style="text-align: center;" class="table table-hover">
                            <h3>Daftar Request Gambar</h3>
                            <tr>
                                <th>No</th>
                                <th>File</th>
                                <th>Aksi</th>
                            </tr>
                            @foreach ($informasiGambar as $gambar)
                                <tr>
                                    <td>
                                        {{$loop->iteration}}
                                    </td>
                                    ...
                                    <td>
                                        <a href="/admin/detail/{{$gambar->imageId}}">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
                        ...
                        <table border="1" cellpadding="10" style="text-align: center;" class="table table-hover">
                            ...
                            @foreach ($informasiFile as $File)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{'assets/upload/'.$File->name}}">{{$File->name}}</a>
                                    </td>
                                    <td>
                                        <a href="/admin/detail2/{{$File->fileId}}">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
